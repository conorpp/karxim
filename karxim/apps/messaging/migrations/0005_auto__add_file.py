...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'File'
        db.create_table(u'messaging_file', (
            ...
            ('item', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'messaging', ['File'])


    def backwards(self, orm):
        # Deleting model 'File'
        db.delete_table(u'messaging_file')
    ...
    models = {
        ...
        u'messaging.file': {
            ...
            'item': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['messaging.Message']", 'null': 'True', 'blank': 'True'})
        },
        u'messaging.message': {
            ...
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'item': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'lastActive': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 27, 0, 0)', 'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
