...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.location'
        db.add_column(u'messaging_discussion', 'location',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discussion.location'
        db.delete_column(u'messaging_discussion', 'location')
