...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'messaging_file', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=None, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'File.created'
        db.delete_column(u'messaging_file', 'created')
