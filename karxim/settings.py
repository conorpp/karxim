# Django development settings for karxim project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'karxim',                    # Or path to database file if using sqlite3.
        'USER': 'dev',
        'PASSWORD': 'password',
        'HOST': '',                             # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
        'PORT': '8003',                             # Set to empty string for default.
    }
}
REDIS_PORT = 14177
...
ALLOWED_HOSTS = ['*','localhost','*.karxim.com', 'karxim.com',] 
...
STATICFILES_DIRS = (
    os.path.join(SITE_ROOT, 'static_admin'),
...
MIDDLEWARE_CLASSES = (
    ...
    'karxim.base.ChatMiddleware'
    # Uncomment the next line for simple clickjacking protection:
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware',
)

ROOT_URLCONF = 'karxim.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'karxim.wsgi.application'
